...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('peristiwa_kelahiran', function (Blueprint $table) {
            ...
            $table->foreignId('ayah_warga_id')->constrained('warga', 'warga_id');
            $table->foreignId('ibu_warga_id')->constrained('warga', 'warga_id');
            $table->string('no_akta', 50)->unique()->nullable();
            $table->timestamps();
        });
    }
