...
@media (max-width: 576px) {
    ...
    .keluarga-card-footer .btn {
        ...
        border-radius: 8px !important; /* 🔑 ini kuncinya */
...
@media (max-width: 576px) {
    ...
    .keluarga-card-footer {
        display: flex !important;
        flex-direction: row !important;   /* 🔑 KUNCI */
    ...
    .action-buttons {
        display: flex !important;
        flex-direction: row !important;   /* 🔥 SEJAJAR */
        align-items: center !important;
    ...
    .action-buttons .btn {
        padding: 8px 12px !important;     /* 🔑 ini bikin "tinggi" */
        font-size: 12px !important;
        font-weight: 600 !important;
        border-radius: 8px !important;
        line-height: 1.2 !important;
...
@media (max-width: 576px) {
    ...
    > .d-flex.flex-column.flex-xl-row {
        display: grid !important;
        grid-template-columns: repeat(3, 1fr) !important; /* 🔥 3 SEBARIS */
        gap: 6px !important;
        align-items: center !important;
    }
    ...
    .input-group.flex-grow-1 {
        grid-column: span 3; /* 🔑 search 1 baris penuh */
        width: 100%;
    }
    ...
    select.form-select-sm {
        width: 100% !important;
        max-width: 100% !important; /* ⛔ matikan inline style */
...
@media (max-width: 576px) {
  ...
  .pindah-show-page    .warga-card-body > .row.g-4 {
    display: grid !important;
    grid-template-columns: 1fr 1fr !important; /* 🔑 KUNCI 2 KOLOM */
    gap: 10px !important;
    margin: 0 !important;
  }
...
/* ==================================================
   ABOUT – 2 GAMBAR SAMPINGAN (FINAL FIX)
   ================================================== */
...
/* Animasi kiri */
.animate-left{
    animation: aboutSlideLeft .7s ease-out .15s forwards;
}

/* Animasi kanan */
.animate-right{
    animation: aboutSlideRight .7s ease-out .15s forwards;
}
