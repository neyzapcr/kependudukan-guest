...
@section('content')
    <div class="main-content anggota-page">
        <div class="container">
                            ...
                            <form action="{{ route('anggota.index', $kk->kk_id) }}" method="GET" class="d-flex gap-2">
                                ...
                                <select name="hubungan" class="form-select form-select-sm" onchange="this.form.submit()">
                                    ...
                                    <option value="Kepala Keluarga"
                                        {{ request('hubungan') == 'Kepala Keluarga' ? 'selected' : '' }}>
                                        Kepala Keluarga
                                    </option>
                                    <option value="Istri" {{ request('hubungan') == 'Istri' ? 'selected' : '' }}>Istri
                                    </option>
                                    <option value="Suami" {{ request('hubungan') == 'Suami' ? 'selected' : '' }}>Suami
                                    </option>
                                    <option value="Anak" {{ request('hubungan') == 'Anak' ? 'selected' : '' }}>Anak</option>
                                    <option value="Orang Tua" {{ request('hubungan') == 'Orang Tua' ? 'selected' : '' }}>Orang
                                        Tua</option>
                                    <option value="Lainnya" {{ request('hubungan') == 'Lainnya' ? 'selected' : '' }}>Lainnya
                                    </option>
                                </select>
                                ...
                                <select name="sort" class="form-select form-select-sm" onchange="this.form.submit()">
                                    ...
                                    <option value="hubungan_asc" {{ request('sort') == 'hubungan_asc' ? 'selected' : '' }}>
                                        Hubungan ↑</option>
                                    <option value="hubungan_desc" {{ request('sort') == 'hubungan_desc' ? 'selected' : '' }}>
                                        Hubungan ↓</option>
                                    <option value="created_at_desc"
                                        {{ request('sort') == 'created_at_desc' ? 'selected' : '' }}>Terbaru</option>
                        ...
                        <div class="col-xl-4 col-lg-6 mb-4">
                            <div class="warga-card">
                                ...
                                <div class="warga-card-footer">
                                    ...
                                    @if (session('is_logged_in'))
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('anggota.edit', $item->anggota_id) }}"
                                                class="btn btn-edit">
                                                <i class="fas fa-edit me-1"></i>Edit
                                            </a>

                                            <form action="{{ route('anggota.destroy', $item->anggota_id) }}"
