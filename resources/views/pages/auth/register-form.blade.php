    ...
    <div class="login-right-section">
      <form class="login-form-horizontal" method="POST" action="{{ route('register.post') }}">
        ...
        <div class="form-group-horizontal">
          ...
          <input id="name" type="text" name="name" value="{{ old('name') }}" class="form-control" required placeholder="Masukkan nama lengkap">
        </div>

        <div class="form-group-horizontal">
          <label for="email">Email</label>
          <input id="email" type="email" name="email" value="{{ old('email') }}" class="form-control" required placeholder="Masukkan alamat email">
        </div>
        ...
        <div class="form-group-horizontal">
          ...
          <input id="password_confirmation" type="password" name="password_confirmation" class="form-control" required placeholder="Masukkan ulang password">
        </div>
