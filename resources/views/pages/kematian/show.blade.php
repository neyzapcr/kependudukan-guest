        ...
        <div class="container">
            ...
            <div class="page-header mb-4 text-center">
                <h1 class="page-title mb-1">
                    <i class="fas fa-book-dead me-2"></i>Detail Data Kematian
                </h1>
                <p class="page-subtitle mb-0 text-muted">
                    Informasi lengkap data kematian warga.
                </p>
            </div>
                    ...
                    <div class="warga-card">
                        ...
                        <div class="warga-card-header d-flex align-items-center gap-3">
                            ...
                            <div class="warga-info">
                                <div class="warga-name fw-bold fs-5 d-flex align-items-center">
                                    ...
                                    {{ $kematian->warga->nama ?? 'Nama Tidak Ada' }}
                                </div>
                        ...
                        <div class="warga-card-body">
                            ...
                            <div class="row g-4">
                                ...
                                {{-- KOLOM KIRI: INFO KEMATIAN --}}
                                <div class="col-12 col-md-6">
                                    <h5 class="mb-3">Informasi Kematian</h5>
                                    ...
                                    <div class="row g-2 align-items-start mb-2">
                                        ...
                                        <div class="col-12 col-sm-7">
                                            {{ \Carbon\Carbon::parse($kematian->tgl_meninggal)->format('d/m/Y') }}
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="row g-2 align-items-start mb-2">
                                        ...
                                        <div class="col-12 col-sm-7">
                                            @if (isset($kematian->warga->jenis_kelamin))
                                                {{ $kematian->warga->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan' }}
                                            @else
                                                -
                                            @endif
                                        </div>
                        ...
                        <div
                            ...
                            <small class="text-muted">
                                ...
                                Ditambahkan: {{ $kematian->created_at->format('d/m/Y') }}
                            </small>
                            ...
                            <div class="action-buttons d-flex gap-2 flex-wrap">
                                ...
                                @if (session('is_logged_in'))
                                    <a href="{{ route('kematian.edit', $kematian->kematian_id) }}"
