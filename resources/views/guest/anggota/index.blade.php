                        ...
                        <div class="anggota-card" data-id="{{ $anggota->anggota_id }}">
                            <div class="anggota-card-header">
                                ...
                                <div class="anggota-info">
                                    <div class="anggota-name"><i class="fas fa-user me-1"></i>{{ $anggota->warga->nama ?? '-' }}</div>
                                    <div class="anggota-kk"><i class="fas fa-link me-1"></i>{{ $anggota->hubungan ?? 'Anggota' }}</div>
                                </div>
                            </div>
                            ...
                            <div class="anggota-card-body">
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="info-value">
                                        <span class="{{ ($anggota->warga->jenis_kelamin ?? '') == 'L' ? 'gender-male' : 'gender-female' }}">
                                            <i class="fas fa-{{ ($anggota->warga->jenis_kelamin ?? '') == 'L' ? 'mars' : 'venus' }} me-1"></i>
                            ...
                            <div class="anggota-card-footer">
                                ...
                                <div class="action-buttons">
                                    @if (session('is_logged_in'))
                                        ...
                                        <button class="btn btn-delete" data-id="{{ $anggota->anggota_id }}">
